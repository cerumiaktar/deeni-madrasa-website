...
const BannerBottom = () => {
    return (
        <div>
            <div className="container mx-auto grid grid-cols-2 lg:grid-cols-4 gap-6 absolute inset-x-0 bottom-40">
                <div className="card bg-base-100 shadow-2xl text-[#14535F]">
                    <figure className="px-10 pt-10">
                        <span className="text-5xl"><FaRegClock /></span>
                    </figure>
                    <div className="card-body items-center text-center">
                        <h2 className="text-3xl font-bold">26000+</h2>
                ...
                <div className="card bg-base-100 shadow-2xl text-[#14535F]">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="text-3xl font-bold">0131-2345678</h2>
